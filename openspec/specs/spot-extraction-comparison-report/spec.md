## Purpose
Define the report used to review experimental Gemini-direct spot extraction artifacts alongside the existing transcript-based baseline without invoking paid services during report generation.
