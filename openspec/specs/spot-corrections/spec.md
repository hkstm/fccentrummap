# spot-corrections Specification

## Purpose
Define the maintainer workflow for recording manual spot corrections, resolving corrected place coordinates, and applying timestamp corrections without mutating source extraction data.
