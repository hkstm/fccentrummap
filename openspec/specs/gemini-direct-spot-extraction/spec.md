## Purpose
Define the primary Gemini-direct spot extraction flow that extracts presenter attribution, Amsterdam spot candidates, optional addresses, evidence, timestamps, and confidence from article and YouTube URL context.
