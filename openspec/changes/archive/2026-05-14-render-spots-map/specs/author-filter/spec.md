...
#### Scenario: All presenters deselected
- **WHEN** the user deselects all presenters (including via the deselect-all control)
- **THEN** zero spots SHALL be visible on the map until at least one presenter is selected again
