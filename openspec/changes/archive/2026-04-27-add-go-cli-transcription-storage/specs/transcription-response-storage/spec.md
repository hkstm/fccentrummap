...
- **WHEN** a response payload is not valid JSON
- **THEN** the repository SHALL reject persistence
- **AND** it SHALL return a clear error indicating invalid JSON content
